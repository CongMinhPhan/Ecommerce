...
const WarehouseItem = ({ data }) => {
  ...
  return (
    <div className="w-full bg-white p-6 m-4 shadow-md rounded-lg">
      <h3 className="font-bold text-2xl mb-6 text-gray-800">Kho hàng {warehouseName}</h3>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="text-gray-700">
          <strong className="text-lg">Số điện thoại: </strong>
          <span>{warehousePhoneNumber}</span>
        </div>
        <div className="text-gray-700">
